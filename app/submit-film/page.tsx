...
export default function SubmitFilmPage() {
    ...
    return (
        <main className="min-h-screen bg-[#FFCE21] overflow-x-hidden relative">
            ...
            <div className="absolute left-0 w-2 sm:w-3 md:w-6 lg:w-10 z-20 pointer-events-none" style={{ top: 0, bottom: 'calc(30vh + 01px)', margin: 0, padding: 0 }}>
                <Image
            ...
            <div className="absolute right-0 w-2 sm:w-3 md:w-6 lg:w-10 z-20 pointer-events-none md:top-[108px]" style={{ top: 0, bottom: 'calc(30vh + 1px)', margin: 0, padding: 0 }}>
                <Image
                    src="/assets/orange.svg"
                    alt="Side strip decoration"
                    width={200}
            ...
            <div className="relative w-full">
                ...
                {/* Form Section */}
                <div className="relative bg-[#FFCE21] pb-20 sm:pb-24 md:pb-28 lg:pb-32 pt-0" style={{ marginTop: '-4px', }}>
                    {/* Submission Form Image - Full Width Above Heading */}
                    <div className="w-auto -mx-4 sm:-mx-6 md:-mx-8 lg:-mx-12 xl:-mx-16 mb-6 sm:mb-8 md:mb-10 mt-8 sm:mt-10 md:mt-12 lg:mt-16 ml-4" style={{ transform: 'translateX(13px)' }}>
                        <Image
            ...
            <div className="relative w-full h-[80vh] overflow-hidden z-20 pb-0 sm:pb-12 md:pb-16 mt-8 sm:mt-12 md:mt-16 -mb-[50px] sm:mb-0" style={{ transform: 'translateY(-60px)' }}>
                <Image
