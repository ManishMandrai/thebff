...
export default function TermsPage() {
  return (
    <main className="min-h-screen bg-[#FFCE21] overflow-x-hidden relative">
      ...
      <div className="relative w-full">
        ...
        <div className="relative bg-[#FFCE21] px-4 md:px-8 lg:px-12 xl:px-16 pb-12 md:pb-16 pt-0 min-h-[calc(100vh-80px)]">
            ...
            <div className="relative z-20 pl-4 md:pl-8 lg:pl-12 pr-4 md:pr-8 lg:pr-12 pt-0">
              ...
              <p className="text-[#091529] text-base md:text-lg mb-8 md:mb-12 leading-relaxed">
                By submitting a film to The Bhopal Film Festival, you (the filmmaker/submitter) agree to the following terms and conditions:
              </p>

              {/* Content Sections */}
              <div className="space-y-8 md:space-y-10 text-[#091529]">
              
              {/* AUTHORITY & RIGHTS */}
              <section>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase">AUTHORITY & RIGHTS</h2>
              ...
              {/* ORIGINAL CONTENT */}
              <section>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase">ORIGINAL CONTENT</h2>
                <p className="text-base md:text-lg leading-relaxed">
              ...
              {/* PROHIBITED CONTENT */}
              <section>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase">PROHIBITED CONTENT</h2>
                <p className="text-base md:text-lg leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase">CERTIFICATION & GOVERNMENT CLEARANCE</h2>
                <p className="text-base md:text-lg leading-relaxed">
              ...
              {/* LEGAL CLEARANCES */}
              <section>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase">LEGAL CLEARANCES</h2>
                <p className="text-base md:text-lg leading-relaxed">
              ...
              {/* INSTITUTIONAL FILMS */}
              <section>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase">INSTITUTIONAL FILMS</h2>
                <p className="text-base md:text-lg leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase">USAGE OF SUBMITTED MATERIALS</h2>
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase">NO SCREENING FEE & NO RETURN OF MATERIALS</h2>
                <p className="text-base md:text-lg leading-relaxed">
              ...
              {/* FINAL DECISION */}
              <section>
                <h2 className="text-2xl md:text-3xl font-bold mb-4 uppercase">FINAL DECISION</h2>
                <p className="text-base md:text-lg leading-relaxed mb-4">
      ...
      <div className="relative w-full h-[40vh] overflow-hidden z-20">
        <Image
